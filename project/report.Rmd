...
> Test
gamename <- c("Counter-Strike: Global Offensive",
"Dota 2",
...
is_esport <- c(TRUE, TRUE, TRUE, TRUE, FALSE, TRUE)

esport_df <- data.frame(gamename, is_esport)

esport_df

df_list <- list(games, esport_df)

df_list %>% 
  reduce(full_join, by='gamename')
