...
geom_dl(aes(label = year), method = list(dl.trans(x = x + 0.1), "last.points", cex = 0.8))+ 
 
  
scale_colour_manual(values=c("#ffffff","#f58231","#030000", "#00FBFE", "#3cb44b", "#FF0004", "#4363d8", "#911eb4", "#f032e6", "#a9a9a9" )) 
  
  
# Dr. sanchez gave me an email to help me with the x or y scales gotta check   
