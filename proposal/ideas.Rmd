...
3. Which games have drastic drops or rises in popularity?
4. By how much has the total number of players risen or dropped throughout the years?
...
Most of our current exploratory questions are regarding the trends of gamers and what they are playing. So, we are expecting to see a lot of line graphs to clearly see dips and peaks for these behavior patterns. We also expect to see dips of the popularity of games being followed by high player counts of new releases that are of a similar genre. Of course, in the event more interesting and distinct questions are thought of, we may explore other approaches of analysis. We would also like to see if there is a relationship with the release date and the highest peak(s) of players by adding a column of release dates. The games's Steam release date (at least in terms of months) would be found with the NA values of the data that reflects "monthly gains/losses of players compared to the previous month", because the "NA" represents no data collected due to the game not being out on Steam during the previous month.